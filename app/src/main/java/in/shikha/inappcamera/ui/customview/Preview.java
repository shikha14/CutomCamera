package in.shikha.inappcamera.ui.customview;
...
public class Preview extends ViewGroup implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        // to draw.
        Log.e(TAG, "Inside on surface created");
        try {
            if (mCamera != null) {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        Log.e(TAG, "Inide surfaceDestroyed");
        if (mCamera != null) {
            mCamera.stopPreview();
            mCamera.release();
            mCamera = null;
